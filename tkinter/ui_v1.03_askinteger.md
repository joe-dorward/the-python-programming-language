...
This version, adds the **Simpledialog** menu, and the **Ask Integer** option.

![ui_v1.03_askinteger.py](illustrations/ui_v1.03_askinteger.png)
...
def add_Menubar():
    ...
    # add options
    simpledialog_menu.add_command(label='Ask Integer', command=ask_Integer)
    # ---------- ---------- ---------- ---------- ----------
...
# ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
def ask_Integer():
    # raises the askintger dialog
    print("[DEBUG] ask_Integer() called")

    integer = simpledialog.askinteger(parent=ui, title="Ask Integer", prompt="Enter Integer")
