...
'Frame' widgets with their 'relief' attribute set to 'sunken'.

The second example has its 'highlightthickness' attribute set to '8'.

![ui_v1.11_sunken_frames.py](illustrations/ui_v1.11_sunken_frames.png)

```Python
# ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
# Program ui_v1.11_sunken_frames.py
...
def add_Sunken_Frames():
    ...
    sunken_frame_1 = Frame(ui,
                           borderwidth=border_width,
                           relief='sunken',
                           name="sunken_frame_1")
    
    sunken_frame_1.place(x=frame_left,
                         y=frame_top,
                         width=frame_width,
                         height=frame_height)
    # ---------- ---------- ---------- ---------- ---------- 
    ...
    sunken_frame_2 = Frame(ui,
                           borderwidth=border_width,
                           relief='sunken',
                           highlightthickness=8,
                           name="sunken_frame_2")
    
    sunken_frame_2.place(x=frame_left,
                         y=frame_top,
                         width=frame_width,
                         height=frame_height)
# MAIN ///// ////////// ////////// ////////// ////////// ////////// ////////// //////////
