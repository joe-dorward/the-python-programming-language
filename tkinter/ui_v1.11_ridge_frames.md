...
'Frame' widgets with their 'relief' attribute set to 'ridge'.
...
```Python
# ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
# Program ui_v1.11_ridge_frames.py
...
def add_Menubar():
    ...
    ui['menu'] = menubar_1
# ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
def add_Ridge_Frames():
    # adds 'ridge' frames
    print("[DEBUG] add_Ridge_Frames() called")
    ...
    ridge_frame_1 = Frame(ui,
                          borderwidth=border_width,
                          relief='ridge',
                          name="ridge_frame_1")
    
    ridge_frame_1.place(x=frame_left,                        
                        y=frame_top,                        
                        width=frame_width,                        
                        height=frame_height)
    # ---------- ---------- ---------- ---------- ---------- 
    ...
    ridge_frame_2 = Frame(ui,
                          borderwidth=border_width,
                          relief='ridge',
                          highlightthickness=8,
                          name="ridge_frame_2")
    
    ridge_frame_2.place(x=frame_left,
                        y=frame_top,
                        width=frame_width,
                        height=frame_height)
# MAIN ///// ////////// ////////// ////////// ////////// ////////// ////////// //////////
