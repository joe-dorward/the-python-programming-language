...
def add_Menubar():
    ...
    # add options
    simpledialog_menu.add_command(label='Ask Float', command=Ask_Float)
    # ---------- ---------- ---------- ---------- ----------
...
# ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
def Ask_Float():
    # raises the askfloat dialog
    print("[DEBUG] Ask_Float() called")

    float = simpledialog.askfloat(parent=ui, title="Ask Float", prompt="Enter Float")
